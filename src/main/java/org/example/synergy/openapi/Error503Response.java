...
@ToString
@EqualsAndHashCode
@Schema(name = "Error503Response", description = "Error 503 response model.")
public class Error503Response {
    ...
    @Schema(description = "Error Type", example = "service_unavailable")
