...
public class ResourceAlreadyExistsException extends RuntimeException {
     ...
     */
    public ResourceAlreadyExistsException(String message, String errorKey) {
        super(message);
     ...
     * @param errorKey errorKey
     */
    public ResourceAlreadyExistsException(String message, Throwable throwable, String errorKey) {
        super(message, throwable);
        this.errorKey = errorKey;
    }
}
