...
public class PaginationInfo implements Serializable {
    ...
    public PaginationInfo(Integer pageNumber, Integer pageSize, String sortBy, SortType sortType) {
    ...
    public PaginationInfo(String sortBy, SortType sortType, String defaultSortBy) {
        this.sortBy = StringUtils.isNotBlank(sortBy) ? sortBy : defaultSortBy;
        this.sortType = sortType != null ? sortType : SortType.DESC;
    }
    
    public PaginationInfo(Integer pageNumber, Integer pageSize) {
        this.pageNumber = pageNumber;
        this.pageSize = pageSize != null ? pageSize : Integer.MAX_VALUE;
    }
